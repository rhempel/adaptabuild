...
$(call log_notice,=== cpputest.mak =========================================)
$(call log_notice,SRC_TEST is $(SRC_TEST))

# Force a module specific test source files variable to be empty
#
$(MODULE)_SRC_TEST :=

$(MODULE)_SRC_TEST := $(SRC_TEST)

$(call log_notice,$(MODULE)_SRC_TEST is $($(MODULE)_SRC_TEST))

# Now transform the filenames ending in .c and .cpp into .o files so
...
# Add the module specific test library to the list of modules that must
