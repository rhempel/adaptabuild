...
STM32H7A3xx_LIST := $(foreach _v_,xx AG AI IG II LG LI NG NI QI RG RI VG VI ZG ZI,STM32H7A3$(_v_))

STM32H7B0xx_LIST := $(foreach _v_,AB IB RB VB ZB,STM32H7B0$(_v_))
STM32H7B3xx_LIST := $(foreach _v_,xx AI II LI NI RI VI ZI,STM32H7B3$(_v_))
